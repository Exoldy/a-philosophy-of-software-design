# **ГЛАВА 2: ПРИРОДА СЛОЖНОСТИ**

### **(Или «Почему твой код превращается в тыкву»)**
...
## **2.1. Определение сложности (Чё это вообще такое)**
...
## **2.2. Симптомы болезни (Как понять, что вы в жопе)**
...
## **2.3. Откуда ноги растут (Причины)**
...
## **2.4. Сложность растет как снежный ком**
