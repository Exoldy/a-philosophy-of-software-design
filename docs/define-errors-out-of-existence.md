# **Глава 10. Сотри ошибки из реальности**
...
## **10.1 Почему исключения добавляют геморроя**
...
## **10.3 Уничтожаем ошибки как класс**
...
## **10.4 Пример: Удаление файлов (Windows vs Unix)**
...
## **10.6 Маскировка исключений (Спрячь говно под ковер)**
...
## **10.7 Агрегация исключений (Оптовая закупка)**
...
## **10.8 Просто сдохни (Crash-only software)**
...
## **10.9 Убираем спец-кейсы (Дизайн без "если")**
