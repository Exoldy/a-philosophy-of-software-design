...
*Рис 20.1: Buffer хранит данные в чанках. Внутренние чанки принадлежат Buffer, внешние — нет.*
...
*Рис 20.2: Старый код для выделения места во внутреннем чанке Buffer.*
...
*Рис 20.3: Новый код для выделения места во внутреннем чанке Buffer.*
